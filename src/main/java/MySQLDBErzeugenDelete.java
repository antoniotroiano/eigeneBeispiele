...
public class MySQLDBErzeugenDelete {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            //DB anlegen
            stmt.executeUpdate("CREATE DATABASE IF NOT EXISTS personen;");
            System.out.println("DB erstellt");

            //DB löschen
            //stmt.executeUpdate("DROP DATABASE personen");
            //System.out.println("DB gelöscht");
